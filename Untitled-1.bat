<head>
  ...
  <body id="home">
    ...
    <section class="Jumbotron text-center">
      <img src=""41c076fe42e54ad976299844eceb76ba.jpg" alt="najwa" width="200" class="rounded-circle img-thumbnail"/>
      ...
      <div class="container">
        ...
        <div class="row text-center justify-content-evenly">
          <div class="col-md-4 mb-3">
            <div class="card">
              <img src=""966736b0f455d221d9f3b71f14167b7e.jpg class="card-img-top" alt="BluePink Cake"/>
              <div class="card-body">
            ...
            <div class="col-md-4 mb-3">
              <div class="card">
                <img src=""cl6764a23712648c4db8370b1c0f18ebee.jpgass="card-img-top" alt="BluePink Cake"/>
                <div class="card-body">
              ...
              <div class="row text-center justify-content-evenly">
                <div class="col-md-4 mb-3">
                  <div class="card">
                    <img src=""538b9e2ad37aa80240463afce415e8ec.jpg" class="card-img-top" alt="BluePink Cake"/>
                    <div class="card-body">
